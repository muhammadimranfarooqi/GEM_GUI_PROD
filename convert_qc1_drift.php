...
$outs = trim($out);
//$test=null;
$output=shell_exec("/afs/cern.ch/user/m/mimran/www/prod/my_env_new/bin/python QC1_drift_Data.py '$FileName' '$CHAMBER' $outs '$LOCATION' '$INITIATED_BY_USER' '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP' '$Elog' '$Files' '$comments'");
