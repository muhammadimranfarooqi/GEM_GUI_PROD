...
<?php
  include "head.php";
$output=shell_exec("/afs/cern.ch/user/m/mimran/www/dev/my_env_new/bin/python qc8_stand_geo_conf.py '$FileName' '$LOCATION' '$INITIATED_BY_USER' '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP'");
