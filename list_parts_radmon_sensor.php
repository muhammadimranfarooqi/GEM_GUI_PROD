...
<?php  include "side.php"; ?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header"><img src="images/ROPCB.png" width="4%">Radmon Sensors List</h1>

<a href="new_radmon_sensor.php"><button type="button" class="btn btn-success"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add new Radmon Sensor</button></a>
...
<!--                  <th>Status</th>-->
              ...
              <tbody>
                  <?php $drifts=  get_list_part_ID($RADMON_SENSOR_KIND_OF_PART_ID);
          //print_r($drifts);
          foreach( $drifts as $drift){
              ...
              echo '<tr>
                  ...
                  <td><a href="show_radmon_sensor.php?id='.$drift['SERIAL_NUMBER'].'"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Show</button></a></td>
                </tr>';
          }
...
<script>
        ...
        $("#partslist").show();
$("#<?= $RADMON_SENSOR_ID; ?>").attr("class","active");
})
