...
<?php  include "side.php"; ?>
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h1 class="page-header"><img src="images/ROPCB.png" width="4%"> FPGA List</h1>

<a href="new_frame.php"><button type="button" class="btn btn-success"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Add new FPGA</button></a>
...
<!--                  <th>Status</th>-->
		  ...
		  <th> Record Insertion Time </th>
              ...
              <tbody>
                  <?php $drifts=  get_list_part_ID($FPGA_KIND_OF_PART_ID);
          //print_r($drifts);
 ...
 <td><span aria-hidden="true" class="glyphicon glyphicon-user"> '.$drift['INSERTION_DATE'].' </span></td>
                  ...
                  <td><a href="show_fpga.php?id='.$drift['SERIAL_NUMBER'].'"><button type="button" class="btn btn-info"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span> Show</button></a></td>
                </tr>';
          }
