...
//                    $temp[$NAME_LABEL] = $_POST['serial'];
                    ...
                    if (isset($_POST['barcode']) && !empty($_POST['barcode'])) {
                        ...
                        $kindOfPart = $TEMP_SENSOR_KIND_OF_PART_NAME;
                        //echo  $kindOfPart;
      ...
      <strong>Well done!</strong> You successfully created XML file for GEM Temperature Sensor <strong>ID:</strong> ' . $_POST['serial'] .
                    '</div>';
...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New Temperature Sensor  </h2>
      ...
      <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
                ...
                <form method="POST" action="new_temp_sensor.php">

                    <div class="row">
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>Temperature Sensor Information</h3>
                            </div>
