...
<?php include "side.php"; ?>
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Edit Drift: <?php echo $_GET["id"]; ?> </h2>

                <?php if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    
                    if(isset($_POST['serial'])){
    echo '<div role="alert" class="alert alert-success">
      <strong>Well done!</strong> You successfully edited Drift <strong>ID:</strong> '.$_POST['serial'].
                    '</div>';}
    ...
    ?> 
                ...
                <form method="POST" action="edit_drift.php">
                    ...
                    <div class="row">
                        <div class="col-xs-12 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            ...
                            <!-- <span class="text-muted">List single chambers</span> -->
                             ...
                             <div class="col-md-6"><img alt="200x200" class="img-thumbnail" data-src="holder.js/200x200" style="width: 200px; height: 200px;" src="uploads/DRIFT.png" data-holder-rendered="true"></div>
                            </div>
