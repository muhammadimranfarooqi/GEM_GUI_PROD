...
<?php include "side.php"; ?>
	  ...
	  <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Configuration  </h2>
    ...
    <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
	      ...
	      <form method="POST" action="convert_configurationvfat.php" enctype='multipart/form-data'>
