...
//echo "$outs";
//$test=null;
$output=shell_exec("/afs/cern.ch/user/m/mimran/www/prod/my_env_new/bin/python QC3_Calib_Data.py '$FileName'  '$outs' '$LOCATION' '$INITIATED_BY_USER' '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP' '$Elog' '$Files' '$comments' '$CHAMBER'");
