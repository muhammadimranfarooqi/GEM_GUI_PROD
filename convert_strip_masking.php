...
<?php
  include "head.php";
$output=shell_exec("/afs/cern.ch/user/m/mimran/www/dev/my_env_new/bin/python strip_masking_data.py '$FileName' '$LOCATION' '$INITIATED_BY_USER' '$COMMENT_DESCRIPTION' '$RUN_BEGIN_TIMESTAMP' '$RUN_END_TIMESTAMP'");
...
unlinkr ($dir, "*.zip");
 $_SESSION['post_return'] = $res_arr;
      ...
      <strong>Well done!</strong> Zip file for  Strip Masking Slice Test Data was successfully created and sent to dbloader.  <strong>ID:</strong> ' . $filename .
                    '</div>';
