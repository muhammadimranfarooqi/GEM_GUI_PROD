...
//                    $temp[$NAME_LABEL] = $_POST['serial'];
                    ...
                    if (isset($_POST['barcode']) && !empty($_POST['barcode'])) {
                        ...
                        $kindOfPart = $COOLING_PLATE_KIND_OF_PART_NAME;
                        //echo  $kindOfPart;
      ...
      <strong>Well done!</strong> You successfully created XML file for GEM Cooling Plate <strong>ID:</strong> ' . $_POST['serial'] .
                    '</div>';
...
<div class="container-fluid" >
    <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
            <h2 class="sub-header"> <img src="images/ROPCB.png" width="4%"> <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> New Cooling Plate Circuit  </h2>
      ...
      <span class="glyphicon glyphicon-exclamation-sign" aria-hidden="true"></span><strong>Error!</strong> Please fill the required fields.
                ...
                <form method="POST" action="new_cooling_plate.php">

                    <div class="row">
                        <div class="col-xs-6 panel-info panel" style="padding-left: 0px; padding-right: 0px;">
                            <div class="panel-heading">
                                <h3 class="panel-title" >  <span aria-hidden="true" class="glyphicon glyphicon-info-sign"></span>Cooling Plate Circuit Information</h3>
                            </div>
                            ...
                            <!-- <span class="text-muted">List single chambers</span> -->
                                <div class="form-group">
                                    ...
                                    <div class="serial"><span class="name">CPC<span class="batch"></span>-</span><span id="vers" class="version" >VERSION</span><span class="id">-XXXX</span></div>
...
<script>
    ...
    $('.dropdown-menu a').on('click', function () {
        ...
        $("#partslist").show();
$("#<?= $COOLING_PLATE_ID; ?>").attr("class","active");
})
